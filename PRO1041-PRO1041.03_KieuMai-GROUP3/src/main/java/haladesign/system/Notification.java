...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/haladesign/icon/sucess.png")));
            lbMessage.setText("Success");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/haladesign/icon/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/haladesign/icon/warning.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/haladesign/icon/sucess.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/haladesign/icon/close.png"))); // NOI18N
